...
<div class="mx-auto max-w-4xl px-6 py-16">
  ...
  <div class="prose prose-slate dark:prose-invert max-w-none">
    <div class="space-y-8">
      ...
      <section>
        <h2 class="text-2xl font-bold mb-4 text-slate-900 dark:text-slate-100">2. Scope of Services</h2>
        <h3 class="text-xl font-semibold mb-3 text-slate-800 dark:text-slate-200">2.1 Open-Source Software</h3>
        <p class="text-slate-800 dark:text-slate-300 leading-relaxed mb-4">
          We publish software under open-source licenses, including:
        </p>
        ...
        <p class="text-slate-800 dark:text-slate-300 leading-relaxed">
          Experimental AI models published on HuggingFace (BitTransformerLM, WrinkleBrane), licensed under AGPLv3 or AGPL-3.0 respectively.
        </p>
      </section>

      <section>
        <h2 class="text-2xl font-bold mb-4 text-slate-900 dark:text-slate-100">3. Intellectual Property & Licensing</h2>
        <p class="text-slate-800 dark:text-slate-300 leading-relaxed mb-4">
          <strong>3.1 IP Ownership:</strong> All intellectual property is held by WCNEGENTROPY HOLDINGS LLC. Open-source licenses grant usage rights but do not transfer ownership.
        </p>
        <p class="text-slate-800 dark:text-slate-300 leading-relaxed mb-4">
        ...
        <ul class="list-disc pl-6 space-y-2 text-slate-800 dark:text-slate-300 mb-4">
          ...
          <li>Network use (SaaS) requires source code availability to users</li>
          <li>Proper attribution and copyright notice must be maintained</li>
      ...
      <section>
        ...
        <p class="text-slate-800 dark:text-slate-300 leading-relaxed mb-4">
          <strong>6.1 AS-IS Basis:</strong> ALL SOFTWARE, RESEARCH, AND AI MODELS ARE PROVIDED "AS IS" WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR NON-INFRINGEMENT.
        </p>
        <p class="text-slate-800 dark:text-slate-300 leading-relaxed mb-4">
          <strong>6.2 Third-Party Services:</strong> We are not responsible for the availability, performance, or terms of third-party platforms (GitHub, HuggingFace, NPM, etc.) where our projects are hosted.
        </p>
        <p class="text-slate-800 dark:text-slate-300 leading-relaxed">
          <strong>6.3 Website:</strong> While we strive to keep our website accurate and accessible, we do not guarantee uninterrupted access or error-free content.
        </p>
      </section>
      ...
      <section>
        <h2 class="text-2xl font-bold mb-4 text-slate-900 dark:text-slate-100">8. Contributions</h2>
        <p class="text-slate-800 dark:text-slate-300 leading-relaxed mb-4">
          <strong>8.1 Open-Source Contributions:</strong> By submitting pull requests, issues, or other contributions to our GitHub repositories, you agree that your contributions will be licensed under the same license as the project you are contributing to.
        </p>
        <p class="text-slate-800 dark:text-slate-300 leading-relaxed">
          <strong>8.2 Attribution:</strong> We will provide appropriate attribution to contributors as described in each project's contributing guidelines.
        </p>
      </section>

      <section>
        <h2 class="text-2xl font-bold mb-4 text-slate-900 dark:text-slate-100">9. Governing Law</h2>
        <p class="text-slate-800 dark:text-slate-300 leading-relaxed mb-4">
          <strong>9.1 Jurisdiction:</strong> These Terms are governed by the laws of the State of Delaware, without regard to its conflict of law provisions.
        </p>
        <p class="text-slate-800 dark:text-slate-300 leading-relaxed">
          <strong>9.2 Dispute Resolution:</strong> Before filing any legal action, parties agree to attempt resolution through good-faith negotiation for 30 days.
        </p>
      </section>

      <section>
        <h2 class="text-2xl font-bold mb-4 text-slate-900 dark:text-slate-100">10. General Provisions</h2>
        <p class="text-slate-800 dark:text-slate-300 leading-relaxed mb-4">
          <strong>10.1 Amendments:</strong> We may update these terms at any time. Continued use after changes constitutes acceptance.
        </p>
        <p class="text-slate-800 dark:text-slate-300 leading-relaxed mb-4">
          <strong>10.2 Severability:</strong> If any provision is found unenforceable, the remaining provisions remain in full effect.
        </p>
        <p class="text-slate-800 dark:text-slate-300 leading-relaxed">
          <strong>10.3 Entire Agreement:</strong> These terms, together with the applicable open-source license for each project, constitute the entire agreement between you and WCNegentropy.
        </p>
      </section>
      ...
      <section>
        ...
        <p class="text-slate-800 dark:text-slate-300 leading-relaxed mb-4">
          For questions about these Terms of Service or commercial licensing:
        </p>
